...
const RecMobOfferForm = ({ nav }) => {
  ...
  return (
    <PhoneFrame>
      ...
      <div style={{ padding: 14, background: "#fff", borderTop: "1px solid var(--gj-line)", flexShrink: 0 }}><button style={{ width: "100%", background: "var(--gj-blue)", color: "#fff", border: 0, minHeight: 50, borderRadius: 11, fontWeight: 800, fontSize: 15, cursor: "pointer", fontFamily: "inherit" }}>Soumettre pour validation</button></div>
    </PhoneFrame>
  );
};
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 14, display: "flex", flexDirection: "column", gap: 11, background: "var(--gj-bg)" }}>
        {list.map((c, i) => (
          <div key={c.id} style={{ background: "#fff", border: "1px solid var(--gj-line)", borderRadius: 13, padding: 13, display: "flex", gap: 11, alignItems: "center" }}>
            <div style={{ width: 50, textAlign: "center", flexShrink: 0, background: "var(--gj-blue-soft)", color: "var(--gj-blue-ink)", borderRadius: 10, padding: "7px 4px" }}><div style={{ fontSize: 16, fontWeight: 900, lineHeight: 1 }}>11</div><div style={{ fontSize: 8.5, fontWeight: 800, textTransform: "uppercase", marginTop: 2 }}>Juin</div></div>
