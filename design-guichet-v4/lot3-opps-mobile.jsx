...
const SAMPLE_M = [
  { tag: "STAGE · J-3", tagTone: "urgent", title: "Stage Data Science · 6 mois", org: "Sonatel — Innovation", region: "Dakar", salary: "350 000 F/mois", deadline: { label: "J-3", urgent: true }, match: "94%", fav: true },
  { tag: "EMPLOI · J-12", tagTone: "cjs", title: "Développeur Web Junior", org: "Wave Mobile Money", region: "Dakar", salary: "500 000 F", deadline: { label: "J-12" }, match: "88%" },
  ...
  { tag: "STAGE · J-18", tagTone: "cjs", title: "Stage agronomie · Coopérative", org: "GIE Diaobé", region: "Tambacounda", salary: "180 000 F/mois", deadline: { label: "J-18" }, match: "91%", fav: true },
];
    ...
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={searchWrap}>
        ...
        <button style={{
          ...
          <span style={{ position: "absolute", top: 4, right: 4, minWidth: 16, height: 16, padding: "0 4px", borderRadius: 999, background: "var(--gj-teal-deep)", color: "#fff", fontSize: 9.5, fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>4</span>
        </button>
      </div>
      <div style={chipRow}>
    ...
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={sheet}>
        ...
        <div style={hero}>
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 10.5, fontWeight: 800, background: "var(--gj-red)", color: "#fff", padding: "4px 10px", borderRadius: 999, letterSpacing: ".4px", marginBottom: 10 }}>
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 12, fontWeight: 800, color: "var(--gj-teal-deep)" }}>
                <span style={{ fontFamily: "Georgia, serif", fontSize: 13 }}>Yaye :</span>
                <span style={{ background: "var(--gj-green-soft)", color: "var(--gj-green-ink)", fontSize: 10, fontWeight: 900, padding: "1px 6px", borderRadius: 999, marginLeft: 6 }}>94%</span>
              </div>
...
const MobileApplySheet = () => {
  ...
  return (
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={body}>
        ...
        <div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: 6 }}>
            ...
            <span style={{ fontSize: 10.5, color: "var(--gj-grey)" }}>248 / 1000</span>
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{
            ...
            <div style={{ width: 32, height: 40, borderRadius: 4, background: "var(--gj-red-soft)", color: "var(--gj-red-ink)", display: "inline-flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 9, flexShrink: 0 }}>PDF</div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 12.5, fontWeight: 800 }}>CV_Awa_Diop_2026.pdf</div>
              <div style={{ fontSize: 10.5, color: "var(--gj-grey)" }}>238 Ko · coffre-fort</div>
            </div>
      ...
      <div style={{ padding: "12px 14px 16px", background: "#fff", borderTop: "1.5px solid var(--gj-line)", flexShrink: 0 }}>
        <button style={{
          width: "100%", background: "var(--gj-teal-deep)", color: "#fff",
          border: 0, minHeight: 52, borderRadius: 12,
        ...
        <div style={{ fontSize: 10.5, color: "var(--gj-grey)", textAlign: "center", marginTop: 8, display: "inline-flex", alignItems: "center", gap: 5, width: "100%", justifyContent: "center" }}>
    ...
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "20px 16px 16px", display: "flex", flexDirection: "column", gap: 18, alignItems: "center", textAlign: "center" }}>
        ...
        <div style={{
          ...
          <div style={{
            padding: "14px 16px", background: "#E5F0EC",
            display: "flex", flexDirection: "column", gap: 8,
          }}>
            <div style={{
              ...
              <div style={{ fontSize: 10, color: "var(--gj-grey-2)", marginTop: 4, textAlign: "right" }}>9:41</div>
            </div>
          </div>
        </div>
...
Object.assign(window, { MobileOppList, MobileOppListWithFilters, MobileOppDetailSheet, MobileApplySheet, MobileApplyConfirmation, MobileEmptyState, MobileOppRowCard });
