...
const ymAv = (size = 38) => (
  <span style={{ width: size, height: size, borderRadius: "50%", flexShrink: 0, background: "linear-gradient(135deg, #19A757 0%, #0A807F 100%)", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontFamily: "Georgia, serif", fontSize: size * 0.5, boxShadow: "0 0 0 2px rgba(255,255,255,.25)" }}>Y</span>
);
const ymHead = () => (
  <div style={{ background: "var(--gj-teal-deep)", color: "#fff", padding: "12px 14px", display: "flex", alignItems: "center", gap: 11, flexShrink: 0, position: "relative" }}>
    ...
    <div style={{ flex: 1, minWidth: 0 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 6 }}><span style={{ fontFamily: "Georgia, serif", fontWeight: 900, fontSize: 18, background: "linear-gradient(135deg,#fff,var(--gj-yellow))", WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent" }}>Yaye</span><span style={{ background: "var(--gj-yellow)", color: "var(--gj-teal-deep)", fontSize: 8.5, fontWeight: 900, padding: "2px 6px", borderRadius: 999 }}>IA</span></div>
...
const YayeMobChat = () => {
  ...
  return (
    <PhoneFrame>
      {ymHead()}
      <div style={{ flex: 1, overflowY: "auto", background: "#F5FAF8", padding: "12px 14px", display: "flex", flexDirection: "column", gap: 8 }}>
        <span style={{ alignSelf: "center", fontSize: 10, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".5px", background: "#fff", border: "1px solid var(--gj-line)", borderRadius: 999, padding: "3px 10px" }}>Aujourd'hui</span>
        ...
        <div style={{ maxWidth: "92%", alignSelf: "flex-start", background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, overflow: "hidden" }}>
          <div style={{ background: "#FBF3DE", padding: "9px 12px", display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid var(--gj-line)" }}><span style={{ width: 26, height: 26, borderRadius: 7, flexShrink: 0, background: "#B0820B", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center" }}><svg className="gj-icon" style={{ width: 14, height: 14 }}><use href="#i-funding" /></svg></span><span style={{ fontSize: 11.5, fontWeight: 900, color: "#B0820B", textTransform: "uppercase", letterSpacing: ".4px" }}>Bourse</span><span style={{ flex: 1 }} /><span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11, fontWeight: 800, color: "#B0820B" }}><svg className="gj-icon" style={{ width: 11, height: 11 }}><use href="#i-clock" /></svg>Dépôt J-12</span></div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, padding: 12, background: "#fff", borderTop: "1px solid var(--gj-line)", flexShrink: 0 }}>
        <div style={{ flex: 1, display: "flex", alignItems: "center", gap: 6, border: "1.5px solid var(--gj-line)", borderRadius: 999, padding: "0 6px 0 16px", minHeight: 44, background: "var(--gj-bg)" }}><span style={{ flex: 1, fontSize: 14, color: "var(--gj-grey-2)" }}>Écris ou parle…</span><button style={{ width: 32, height: 32, borderRadius: "50%", border: 0, background: "transparent", color: "var(--gj-teal-deep)", cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center" }} aria-label="Micro"><svg className="gj-icon" style={{ width: 18, height: 18 }}><use href="#i-play" /></svg></button></div>
...
const YayeMobHome = () => (
  <PhoneFrame>
    {ymHead()}
    <div style={{ flex: 1, overflowY: "auto", background: "#F5FAF8", padding: "26px 16px", display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    ...
    return (
      <div key={title} style={{ background: "#fff", border: "1px solid var(--gj-line)", borderRadius: 14, padding: 14, display: "flex", flexDirection: "column", gap: 11 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 5, fontSize: 10.5, fontWeight: 800, color: t.c, background: t.soft, padding: "4px 10px", borderRadius: 999 }}><svg className="gj-icon" style={{ width: 12, height: 12 }}><use href={"#" + t.icon} /></svg>{t.label}</span>
          <span style={{ flex: 1 }} />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, paddingTop: 11, borderTop: "1px solid var(--gj-line)" }}>
          ...
          <span style={{ flex: 1 }} />
          <button style={{ display: "inline-flex", alignItems: "center", gap: 6, background: t.c, color: "#fff", border: 0, padding: "9px 16px", borderRadius: 9, fontWeight: 800, fontSize: 12.5, cursor: "pointer", fontFamily: "inherit" }}>{action || "Voir"}<svg className="gj-icon" style={{ width: 13, height: 13 }}><use href="#i-arrow-right" /></svg></button>
        </div>
      </div>
    );
  };
  return (
    <PhoneFrame>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 14, display: "flex", flexDirection: "column", gap: 12, background: "var(--gj-bg)" }}>
        <div style={{ display: "flex", gap: 10, background: "linear-gradient(135deg, var(--gj-teal-soft), #fff)", border: "1px solid var(--gj-teal)", borderRadius: 13, padding: 12 }}>{ymAv(32)}<div style={{ flex: 1 }}><div style={{ fontSize: 12.5, fontWeight: 800, color: "var(--gj-teal-deep)" }}><span style={{ fontFamily: "Georgia,serif" }}>Le conseil de Yaye</span></div><div style={{ fontSize: 11.5, color: "var(--gj-ink)", marginTop: 3 }}>Voici les opportunités les plus proches de ton parcours cette semaine.</div></div></div>
...
const FileMobScreen = () => {
  const fileRow = (icon, bg, color, border, name, meta, right) => (
    <div key={name} style={{ display: "flex", alignItems: "center", gap: 11, padding: "11px 12px", border: `1.5px solid ${border}`, borderRadius: 11, background: "#fff" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}><div style={{ fontSize: 12.5, fontWeight: 800, color: "var(--gj-ink)" }}>{name}</div><div style={{ fontSize: 10.5, color: "var(--gj-grey)", marginTop: 1 }}>{meta}</div></div>
      {right}
    </div>
  );
  return (
    <PhoneFrame>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 14, display: "flex", flexDirection: "column", gap: 12, background: "var(--gj-bg)" }}>
        ...
        {/* states */}
        {fileRow("i-document", "var(--gj-green-soft)", "var(--gj-green-ink)", "var(--gj-green)", "CV_Awa_Diop.pdf", "Ajouté · 2,4 Mo", <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 10.5, fontWeight: 800, color: "var(--gj-green-ink)", background: "var(--gj-green-soft)", padding: "3px 8px", borderRadius: 999, flexShrink: 0 }}><svg className="gj-icon" style={{ width: 11, height: 11 }}><use href="#i-check" /></svg>OK</span>)}
        {fileRow("i-document", "var(--gj-teal-soft)", "var(--gj-teal-deep)", "var(--gj-teal)", "Lettre_motivation.pdf", "Générée par Yaye", <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 10.5, fontWeight: 800, color: "var(--gj-teal-deep)", background: "var(--gj-teal-soft)", padding: "3px 8px", borderRadius: 999, flexShrink: 0 }}><span style={{ fontFamily: "Georgia,serif", fontWeight: 900 }}>Y</span>Vérifié</span>)}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 11, padding: "11px 12px", border: "1.5px dashed var(--gj-yellow-deep)", borderRadius: 11, background: "var(--gj-yellow-soft)" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}><div style={{ fontSize: 12.5, fontWeight: 800, color: "var(--gj-ink)" }}>Pièce d'identité (CNI)</div><div style={{ fontSize: 10.5, color: "var(--gj-yellow-ink)", marginTop: 1 }}>Requis — non fourni</div></div>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", border: "1.5px solid var(--gj-green)", borderRadius: 11, background: "#fff" }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}><div style={{ fontSize: 12.5, fontWeight: 800, color: "var(--gj-ink)" }}>CV_Awa_Diop.pdf</div><div style={{ fontSize: 10.5, color: "var(--gj-green-ink)", marginTop: 1 }}>Ajouté · 2,4 Mo</div></div>
            ...
            <div style={{ border: "2px dashed var(--gj-line-strong)", borderRadius: 11, padding: "12px", display: "flex", alignItems: "center", gap: 10, background: "#fff" }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}><div style={{ fontSize: 12.5, fontWeight: 800, color: "var(--gj-ink)" }}>Pièce d'identité</div><div style={{ fontSize: 10.5, color: "var(--gj-grey)", marginTop: 1 }}>Requis · PDF, JPG</div></div>
              <button style={{ background: "var(--gj-teal-deep)", color: "#fff", border: 0, padding: "7px 13px", borderRadius: 8, fontWeight: 800, fontSize: 11.5, cursor: "pointer", fontFamily: "inherit", flexShrink: 0 }}>Ajouter</button>
            </div>
          </div>
        </div>
