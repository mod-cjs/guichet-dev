...
(function () {
  ...
  css.textContent = [
    ...
    "html.gjk :focus-visible{outline:4px solid #1A4ED8 !important;outline-offset:2px !important;border-radius:3px;}",
    "html.gjk a:focus-visible,html.gjk button:focus-visible,html.gjk [role=button]:focus-visible{box-shadow:0 0 0 4px rgba(26,78,216,.25)!important;}",
    /* contraste élevé : on surcharge les tokens couleur (cascade partout) */
    "html.gjc{--gj-ink:#000;--gj-grey:#1f1f1f;--gj-grey-2:#3a3a3a;--gj-line:#6b6b6b;--gj-line-strong:#2b2b2b;}",
    ...
    /* guide de lecture */
    "#gj-guide{position:fixed;left:0;right:0;height:38px;background:rgba(249,196,0,.16);border-top:2px solid rgba(10,128,127,.55);border-bottom:2px solid rgba(10,128,127,.55);pointer-events:none;z-index:2147483640;display:none;}",
    "html.gjguide #gj-guide{display:block;}",
    /* lecture vocale : indique les zones cliquables-à-lire */
    "html.gjv [data-gj-readable]:hover{outline:2px dashed rgba(10,128,127,.6)!important;outline-offset:1px;}",
    /* panneau */
    "#gj-fab{position:fixed;left:18px;bottom:18px;width:54px;height:54px;border-radius:50%;background:linear-gradient(135deg,#0A807F,#074D39);color:#fff;border:0;cursor:pointer;z-index:2147483646;box-shadow:0 8px 24px rgba(0,0,0,.32);display:inline-flex;align-items:center;justify-content:center;}",
    "#gj-fab:focus-visible{outline:4px solid #F9C400;outline-offset:3px;}",
    "#gj-panel{position:fixed;left:18px;bottom:82px;width:312px;max-height:78vh;overflow-y:auto;background:#fff;border:1.5px solid #d9e2df;border-radius:18px;z-index:2147483646;box-shadow:0 24px 60px rgba(0,0,0,.3);font-family:system-ui,-apple-system,'Segoe UI',Roboto,sans-serif;color:#0E1F1B;display:none;}",
    "#gj-panel.open{display:block;}",
    "#gj-panel header{display:flex;align-items:center;gap:9px;padding:15px 16px;border-bottom:1.5px solid #eef2f0;position:sticky;top:0;background:#fff;border-radius:18px 18px 0 0;}",
    "#gj-panel h2{font-size:15px;font-weight:800;margin:0;flex:1;}",
    "#gj-panel .gj-x{width:32px;height:32px;border:0;background:#f0f4f2;border-radius:8px;cursor:pointer;font-size:16px;color:#384;}",
    "#gj-panel .gj-body{padding:8px 14px 14px;}",
    "#gj-panel .gj-row{display:flex;align-items:center;gap:11px;padding:10px 4px;border-bottom:1px solid #f0f4f2;}",
    "#gj-panel .gj-row:last-child{border-bottom:0;}",
    "#gj-panel .gj-ic{width:34px;height:34px;border-radius:9px;background:#e9f3f0;color:#0A807F;display:inline-flex;align-items:center;justify-content:center;flex-shrink:0;}",
    "#gj-panel .gj-tx{flex:1;min-width:0;}",
    "#gj-panel .gj-tt{font-size:13px;font-weight:700;line-height:1.2;}",
    "#gj-panel .gj-sub{font-size:11px;color:#5b6b66;margin-top:1px;}",
    "#gj-panel .gj-sw{width:46px;height:27px;border-radius:999px;border:0;background:#c7d2ce;position:relative;cursor:pointer;flex-shrink:0;}",
    "#gj-panel .gj-sw[aria-checked=true]{background:#0A807F;}",
    ...
    "#gj-panel .gj-seg button{min-width:34px;height:30px;border-radius:8px;border:1.5px solid #d9e2df;background:#fff;font-weight:800;font-size:12px;cursor:pointer;color:#5b6b66;}",
    "#gj-panel .gj-seg button[aria-pressed=true]{background:#0A807F;border-color:#0A807F;color:#fff;}",
    "#gj-panel .gj-reset{width:100%;margin-top:10px;padding:11px;border:1.5px solid #d9e2df;background:#fff;border-radius:10px;font-weight:800;font-size:13px;cursor:pointer;color:#0A807F;}",
    "#gj-panel .gj-note{font-size:10.5px;color:#7c8a85;padding:8px 4px 2px;line-height:1.4;}"
  ].join("");
