...
const RecruteurSidebar = ({ active = "home", onNavChange = () => {} }) => {
  ...
  const sectionH = { fontSize: 9.5, color: "var(--gj-grey)", fontWeight: 800, letterSpacing: ".5px", textTransform: "uppercase", padding: "14px 10px 5px" };
  ...
  const badge = (muted) => ({ marginLeft: "auto", background: muted ? "var(--gj-line)" : "var(--gj-blue)", color: muted ? "var(--gj-grey)" : "#fff", fontSize: 9.5, fontWeight: 800, padding: "2px 7px", borderRadius: 10 });
  ...
  return (
    <aside style={wrap}>
      <div style={brandBox}>
        ...
        <span style={{ fontSize: 9, fontWeight: 800, color: "var(--gj-blue-ink)", letterSpacing: ".5px", textTransform: "uppercase", lineHeight: 1.2, borderLeft: "1px solid var(--gj-line)", paddingLeft: 9 }}>Espace<br />recruteur</span>
      </div>
      ...
      <div style={companyChip}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 10.5, color: "var(--gj-blue-ink)", fontWeight: 700, display: "inline-flex", alignItems: "center", gap: 4 }}>
...
const RecruteurTopBar = ({ title, sub }) => (
  <div style={{ background: "#fff", borderBottom: "1px solid var(--gj-line)", padding: "0 24px", display: "flex", alignItems: "center", gap: 14, minHeight: 64, flexShrink: 0 }}>
    ...
    <button style={{ width: 42, height: 42, display: "inline-flex", alignItems: "center", justifyContent: "center", background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 10, color: "var(--gj-grey)", cursor: "pointer", position: "relative", flexShrink: 0 }} aria-label="Notifications">
      ...
      <span style={{ position: "absolute", top: -4, right: -4, minWidth: 18, height: 18, padding: "0 5px", borderRadius: 999, background: "var(--gj-red)", color: "#fff", fontSize: 10, fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center", border: "2px solid #fff" }}>6</span>
    </button>
