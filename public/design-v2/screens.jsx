...
const CandidaturesPipeline = () => {
  ...
  const stepLabels = (
    <div style={{ display: "flex", justifyContent: "space-between", marginTop: 4, fontSize: 9.5, color: "var(--gj-grey)", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".4px" }}>
  ...
  return (
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={body}>
        <div style={tabs}>
          <button style={tab(true)}>Toutes <span style={{ background: "rgba(255,255,255,.2)", padding: "1px 6px", borderRadius: 999, fontSize: 10 }}>5</span></button>
          <button style={tab(false)}>À compléter <span style={{ background: "var(--gj-yellow-soft)", color: "var(--gj-yellow-ink)", padding: "1px 6px", borderRadius: 999, fontSize: 10 }}>1</span></button>
          <button style={tab(false)}>En cours <span style={{ background: "var(--gj-blue-soft)", color: "var(--gj-blue)", padding: "1px 6px", borderRadius: 999, fontSize: 10 }}>2</span></button>
          <button style={tab(false)}>Décidées <span style={{ background: "var(--gj-green-soft)", color: "var(--gj-green)", padding: "1px 6px", borderRadius: 999, fontSize: 10 }}>1</span></button>
        ...
        <div style={list}>
          ...
          <div style={card}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", background: "var(--gj-blue-soft)", border: "1.5px solid #C9D5F5", borderRadius: 8 }}>
              <div style={{ width: 36, height: 36, borderRadius: 8, background: "#fff", color: "var(--gj-blue)", border: "1.5px solid #C9D5F5", display: "inline-flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flexShrink: 0, lineHeight: 1 }}>
                <span style={{ fontSize: 8, fontWeight: 800 }}>MAI</span>
...
const YayeFullScreen = () => {
  const body = { flex: 1, overflowY: "auto", background: "#F5FAF8", padding: "12px 14px 8px", display: "flex", flexDirection: "column", gap: 8 };
  ...
  const av = {
    ...
    background: "linear-gradient(135deg, #19A757 0%, #0A807F 100%)",
    color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center",
    fontWeight: 900, fontFamily: "Georgia, serif", fontSize: 19,
  ...
  // Bubbles
  const dayChip = {
    alignSelf: "center", fontSize: 10, fontWeight: 800,
  ...
  const srcChip = {
    fontSize: 10.5, color: "var(--gj-grey)", fontWeight: 600,
  ...
  return (
    <PhoneFrame bg="#F5FAF8">
      <div style={head}>
        ...
        <div style={{ flex: 1, minWidth: 0, lineHeight: 1.15 }}>
          ...
          <div style={{ fontSize: 11, opacity: .9, display: "inline-flex", alignItems: "center", gap: 5, marginTop: 1 }}>
            <span style={{ width: 7, height: 7, borderRadius: "50%", background: "#7BE5B5", boxShadow: "0 0 0 0 rgba(123,229,181,.7)", animation: "gj-pulse-live 1.8s ease-out infinite" }} />
      ...
      <div style={inputRow}>
        ...
        <button style={{ width: 44, height: 44, border: 0, background: "transparent", cursor: "pointer", color: "var(--gj-grey)" }} aria-label="Micro">
          <svg className="gj-icon"><use href="#i-mic" /></svg>
        </button>
...
const NotificationsScreen = () => {
  ...
  const tMeta = { fontSize: 10.5, color: "var(--gj-grey-2)", marginTop: 4, display: "inline-flex", alignItems: "center", gap: 6 };
  ...
  return (
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={body}>
        ...
        <div style={tabRow}>
          <button style={tab(true)}>Toutes <span style={{ background: "rgba(255,255,255,.2)", padding: "1px 6px", borderRadius: 999, fontSize: 10 }}>12</span></button>
          <button style={tab(false)}>Deadlines <span style={{ background: "var(--gj-red-soft)", color: "var(--gj-red-ink)", padding: "1px 6px", borderRadius: 999, fontSize: 10 }}>2</span></button>
          <button style={tab(false)}>Candidatures <span style={{ background: "var(--gj-blue-soft)", color: "var(--gj-blue)", padding: "1px 6px", borderRadius: 999, fontSize: 10 }}>4</span></button>
          <button style={tab(false)}>Messages <span style={{ background: "var(--gj-bg)", padding: "1px 6px", borderRadius: 999, fontSize: 10 }}>3</span></button>
