...
const aAvatar = (init, size = 40, gold) => (
  <span style={{ width: size, height: size, borderRadius: "50%", flexShrink: 0,
    ...
    fontWeight: 800, fontSize: size * 0.36 }}>{init}</span>
);
        ...
        return (
          <div key={i} onClick={() => s.urgent && nav("resa")} style={{ ...aCard, padding: 16, cursor: s.urgent ? "pointer" : "default", borderColor: s.urgent ? "var(--gj-yellow)" : "var(--gj-line)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              ...
              {s.urgent && <span style={{ fontSize: 9.5, fontWeight: 800, color: "var(--gj-yellow-ink)", background: "var(--gj-yellow-soft)", padding: "2px 8px", borderRadius: 999 }}>ACTION</span>}
            </div>
            ...
            return (
              <div key={r.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "11px 0", borderBottom: "1px solid var(--gj-line)" }}>
                ...
                <div style={{ display: "flex", gap: 6 }}>
                  <button style={{ width: 34, height: 34, borderRadius: 8, border: 0, background: "var(--gj-green)", color: "#fff", cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center" }} aria-label="Accepter"><svg className="gj-icon" style={{ width: 16, height: 16 }}><use href="#i-check" /></svg></button>
                  <button style={{ width: 34, height: 34, borderRadius: 8, border: "1.5px solid var(--gj-line)", background: "#fff", color: "var(--gj-red)", cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center" }} aria-label="Refuser"><svg className="gj-icon" style={{ width: 16, height: 16 }}><use href="#i-close" /></svg></button>
                </div>
              </div>
            );
          })}
          ...
          {A_RDV.slice(0, 4).map((r, i, arr) => (
            <div key={r.id} style={{ display: "flex", gap: 12, paddingBottom: i < arr.length - 1 ? 14 : 0 }}>
              <div style={{ width: 44, flexShrink: 0, textAlign: "right" }}>
                ...
                <div style={{ fontSize: 10, color: "var(--gj-grey-2)" }}>{r.dur}</div>
              </div>
      ...
      <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, justifyContent: "space-between" }}>
            <span style={{ fontSize: 15, fontWeight: 800, color: "var(--gj-ink)" }}>{r.res}</span>
            {aStatusPill(r.status)}
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 6 }}>
            {aAvatar(r.init, 24)}
            <span style={{ fontSize: 12.5, fontWeight: 700, color: "var(--gj-ink)" }}>{r.who}</span>
            <span style={{ fontSize: 11.5, color: "var(--gj-grey)" }}>· {r.age} ans · demandé {r.asked}</span>
          </div>
          ...
          <div style={{ fontSize: 12.5, color: "var(--gj-grey)", marginTop: 8, fontStyle: "italic" }}>« {r.motif} »</div>
        </div>
      </div>
      {r.note && (
...
const AgentBenefList = ({ onOpen }) => (
  <div style={{ padding: "22px 28px 40px", overflowY: "auto", flex: 1 }}>
    ...
    <div style={{ background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, overflow: "hidden" }}>
      <div style={{ display: "grid", gridTemplateColumns: "2.2fr 1.2fr 1.6fr 0.8fr 1fr 0.4fr", gap: 14, padding: "12px 18px", borderBottom: "1.5px solid var(--gj-line)", background: "var(--gj-bg)", fontSize: 10.5, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".4px" }}>
...
const AgentBenefDetail = ({ onBack, nav }) => {
  const b = A_BENEF[0];
  const kv = (label, val) => (
    <div><div style={{ fontSize: 10.5, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".3px" }}>{label}</div><div style={{ fontSize: 13.5, fontWeight: 700, color: "var(--gj-ink)", marginTop: 2 }}>{val}</div></div>
  );
  return (
    <div style={{ padding: "22px 28px 40px", overflowY: "auto", flex: 1 }}>
          ...
          <aside style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={aCard}>
              ...
              <div style={{ background: "var(--gj-yellow-soft)", borderRadius: 9, padding: "11px 13px", fontSize: 12.5, color: "var(--gj-ink)", lineHeight: 1.5 }}>
                ...
                <div style={{ fontSize: 10.5, color: "var(--gj-grey)", marginTop: 6 }}>C. Ndiaye · 2 mai 2026</div>
              </div>
