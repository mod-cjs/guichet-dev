              ...
              <div key={th.id} onClick={() => setActive(th.id)} style={{ display: "flex", gap: 11, padding: "13px 18px", borderBottom: "1px solid var(--gj-line)", cursor: "pointer", background: on ? "var(--gj-teal-soft)" : "transparent" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", gap: 8 }}>
                    <span style={{ fontSize: 13.5, fontWeight: 800, color: "var(--gj-ink)", display: "inline-flex", alignItems: "center", gap: 5 }}>{th.who}{th.ai && <span style={{ background: "var(--gj-yellow)", color: "var(--gj-teal-deep)", fontSize: 8, fontWeight: 900, padding: "1px 5px", borderRadius: 999 }}>IA</span>}</span>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: 20, display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          {t.msgs.map((m, i) => (
            <div key={i} style={{ display: "flex", justifyContent: m.me ? "flex-end" : "flex-start" }}>
              <div style={{ maxWidth: "66%", background: m.me ? "var(--gj-teal-deep)" : "#fff", color: m.me ? "#fff" : "var(--gj-ink)", border: m.me ? 0 : "1px solid var(--gj-line)", borderRadius: m.me ? "14px 14px 4px 14px" : "14px 14px 14px 4px", padding: "10px 14px", fontSize: 13.5, lineHeight: 1.45 }}>{m.t}<div style={{ fontSize: 10, opacity: .6, marginTop: 4, textAlign: "right" }}>{m.time}</div></div>
            </div>
          ))}
        </div>
              ...
              <div key={s.id} style={{ ...bxCard, padding: 16, display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                    <span style={{ fontSize: 9.5, fontWeight: 800, color: g[1], background: g[0], padding: "2px 8px", borderRadius: 999, textTransform: "uppercase", letterSpacing: ".3px" }}>{s.type}</span>
