...
const serviceChip = (s) => (
  <span key={s} style={{ fontSize: 11, fontWeight: 600, color: "var(--gj-grey)", background: "var(--gj-bg)", padding: "4px 10px", borderRadius: 999, border: "1px solid var(--gj-line)" }}>{s}</span>
);
  ...
  <div onClick={onOpen} style={{ background: "#fff", border: c.mine ? "1.5px solid var(--gj-teal)" : "1.5px solid var(--gj-line)", borderRadius: 12, padding: 15, display: "flex", gap: 14, cursor: "pointer", alignItems: "flex-start" }}>
    ...
    <div style={{ flex: 1, minWidth: 0 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        ...
        {c.mine && <span style={{ fontSize: 9.5, fontWeight: 800, color: "var(--gj-teal-deep)", background: "var(--gj-teal-soft)", padding: "2px 8px", borderRadius: 999, textTransform: "uppercase", letterSpacing: ".3px" }}>Mon centre</span>}
        <span style={{ flex: 1 }} />
    ...
    <div style={{ background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 13, padding: 15, display: "flex", gap: 14, alignItems: "center" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          ...
          <span style={{ fontSize: 10, fontWeight: 800, color: "var(--gj-green-ink)", background: "var(--gj-green-soft)", padding: "2px 8px", borderRadius: 999, textTransform: "uppercase", letterSpacing: ".3px" }}>Gratuit</span>
        </div>
  ...
  return (
    <div style={{ maxWidth: 1080, margin: "0 auto", width: "100%" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, var(--gj-teal-deep) 0%, var(--gj-ink-teal) 100%)", color: "#fff", borderRadius: 16, padding: "22px 26px", position: "relative", overflow: "hidden", display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 20 }}>
        <span style={{ position: "absolute", right: -50, top: -60, width: 240, height: 240, background: "radial-gradient(circle, rgba(249,196,0,.16), transparent 60%)", pointerEvents: "none" }} />
        <div style={{ position: "relative" }}>
          <span style={{ fontSize: 10.5, fontWeight: 800, color: "var(--gj-yellow)", textTransform: "uppercase", letterSpacing: ".5px" }}>Mon centre · {c.region}</span>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 14 }}>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 6, background: "rgba(255,255,255,.12)", border: "1px solid rgba(255,255,255,.2)", padding: "5px 11px", borderRadius: 999, fontSize: 12, fontWeight: 700 }}><span style={{ width: 7, height: 7, borderRadius: "50%", background: "#7BE5B5" }} />Ouvert · {c.hours}</span>
        ...
        <div style={{ position: "relative", width: 150, flexShrink: 0 }}>
          <SenegalMap pins={centrePins(c.id)} height={150} bg="#0c3a2c" showLabels={false} />
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 22, alignItems: "start" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <div style={{ background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, padding: 16, display: "flex", gap: 14, alignItems: "center" }}>
            ...
            <span style={{ fontSize: 10.5, fontWeight: 800, color: "var(--gj-green-ink)", background: "var(--gj-green-soft)", padding: "3px 10px", borderRadius: 999 }}>Gratuit</span>
          </div>
        ...
        <aside style={{ position: "sticky", top: 0, background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, padding: 18, display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          <button style={{ marginTop: 6, background: "var(--gj-teal-deep)", color: "#fff", border: 0, minHeight: 50, borderRadius: 10, fontWeight: 800, fontSize: 14.5, cursor: "pointer", fontFamily: "inherit", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
...
const CardContent = ({ onBack }) => (
  <div style={{ maxWidth: 760, margin: "0 auto", width: "100%" }}>
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18, alignItems: "start" }}>
      <div>
        <div style={{ fontSize: 10.5, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".5px", marginBottom: 8 }}>Recto</div>
        <MyCJSCard maxWidth={460} />
      </div>
      <div>
        <div style={{ fontSize: 10.5, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".5px", marginBottom: 8 }}>Verso</div>
