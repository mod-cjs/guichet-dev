...
const WebOnboard1Landing = () => {
  ...
  const eyebrow = {
    ...
    fontSize: 11, fontWeight: 800,
    background: "rgba(249,196,0,.22)", color: "var(--gj-yellow)",
    ...
    <div style={root}>
      <div style={top}>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <button style={{ background: "var(--gj-teal-deep)", color: "#fff", border: 0, padding: "10px 18px", borderRadius: 8, fontWeight: 800, fontSize: 13, cursor: "pointer", fontFamily: "inherit" }}>Créer mon compte →</button>
        </div>
      </div>
      ...
      <div style={hero}>
        ...
        <div style={{ display: "flex", flexDirection: "column", position: "relative" }}>
          ...
          <h1 style={h1}>Ton avenir,<br />commence ici.</h1>
          <p style={lead}>
            Emploi · stage · bourse · projet · formation. Toutes les opportunités pour les <b>16–35 ans au Sénégal</b>, en un seul endroit. Yaye t'accompagne — en français ou en Wolof.
          </p>
          <div style={ctaRow}>
            <button style={ctaPri}>
            ...
            <button style={ctaGhost}>Continuer avec WhatsApp</button>
          </div>
          <div style={stats}>
        ...
        <div style={heroSide}>
          ...
          <div style={oppCard}>
            <span style={oppTag}>URGENT · J-3</span>
            <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <div style={testCard}>
            <div style={{
              ...
              fontWeight: 900, fontFamily: "Georgia, serif", fontSize: 18, flexShrink: 0,
            }}>Y</div>
            <div style={{ flex: 1, color: "#fff" }}>
              <div style={{ fontSize: 13, fontWeight: 800 }}>
                <span style={{ background: "linear-gradient(135deg,#fff,var(--gj-yellow))", WebkitBackgroundClip: "text", color: "transparent", fontFamily: "Georgia, serif" }}>Yaye</span>
                <span style={{ background: "var(--gj-yellow)", color: "var(--gj-teal-deep)", fontSize: 9, fontWeight: 900, padding: "1px 5px", borderRadius: 999, marginLeft: 6 }}>IA</span>
              </div>
        ...
        <div style={leftPane}>
          ...
          <div style={{ position: "relative" }}>
            <div style={{
              ...
              fontSize: 11, fontWeight: 800, background: "rgba(249,196,0,.22)",
            ...
            <div style={{ display: "flex", gap: 6, marginTop: 8 }}>
              {[
                ...
                <button key={i} style={{
                  ...
                  <span style={{ fontSize: 9, color: "var(--gj-grey)" }}>{o.r}</span>
                </button>
              ))}
            </div>
          </div>
        ...
        <div style={card}>
          <div style={yayeBar}>
            <div style={{
              ...
              background: "linear-gradient(135deg, #19A757, #0A807F)",
              color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center",
              fontWeight: 900, fontFamily: "Georgia, serif", fontSize: 22, flexShrink: 0,
            }}>Y</div>
            <div>
    ...
    <div style={root}>
      ...
      <div style={main}>
        <div style={card}>
          ...
          <div style={grid2}>
            <div>
              <FieldLabelW>Commune <span style={{ fontSize: 10, color: "var(--gj-grey-2)", marginLeft: 4 }}>FACULTATIF</span></FieldLabelW>
              <InputW value="" placeholder="ex. Bakel, Kidira, Goudiry…" />
            </div>
            <div>
              <FieldLabelW>Niveau d'études <span style={{ fontSize: 10, color: "var(--gj-grey-2)", marginLeft: 4 }}>FACULTATIF</span></FieldLabelW>
...
const WebOnboard5Preview = () => {
  ...
  const opps = [
    { tag: "URGENT · J-3", tagBg: "var(--gj-red-soft)", tagFg: "var(--gj-red-ink)", icon: "i-agriculture", iconBg: "var(--gj-yellow-soft)", iconFg: "var(--gj-yellow-ink)", title: "Bourse agricole — maraîchage", sub: "600 000 FCFA · Tambacounda", match: 94, why: "Région · âge · objectif" },
    { tag: "STAGE · J-12", tagBg: "var(--gj-blue-soft)", tagFg: "var(--gj-blue)", icon: "i-employment", iconBg: "var(--gj-teal-soft)", iconFg: "var(--gj-teal-deep)", title: "Stage agronomie — Coopérative régionale", sub: "180 000 F/mois · 6 mois", match: 91, why: "Région · objectif" },
    { tag: "CONCOURS · J-21", tagBg: "var(--gj-yellow-soft)", tagFg: "var(--gj-yellow-ink)", icon: "i-trending", iconBg: "var(--gj-yellow-soft)", iconFg: "var(--gj-yellow-ink)", title: "Concours Jeunes Entrepreneurs", sub: "2 500 000 FCFA + coaching", match: 90, why: "Objectif · âge" },
  ];
        ...
        <div style={card}>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <div style={{
              ...
              background: "linear-gradient(135deg, #19A757, #0A807F)",
              color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center",
              fontWeight: 900, fontFamily: "Georgia, serif", fontSize: 28, flexShrink: 0,
