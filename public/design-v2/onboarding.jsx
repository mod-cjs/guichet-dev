...
const FieldLabel = ({ children, required }) => (
  <label style={{
    ...
    {children}
    {required && <span style={{ color: "var(--gj-red)", fontSize: 10 }}>*</span>}
  </label>
);
...
const Onboard1Welcome = () => {
  ...
  const statL = { fontSize: 10, opacity: .8, textTransform: "uppercase", letterSpacing: ".4px" };
  const cta = {
  ...
  return (
    <PhoneFrame bg="var(--gj-ink-teal)" bottomSafe={false} sb={false}>
      ...
      <div style={hero}>
        ...
        <h1 style={headline}>Trouve ta prochaine opportunité.</h1>
        <p style={lead}>Emploi · stage · bourse · projet. Pour les 16–35 ans, partout au Sénégal.</p>
        <div style={photoCard}>
      ...
      <div style={ctaWrap}>
        <button style={cta}>
          Créer mon compte <svg className="gj-icon gj-icon--sm" aria-hidden="true"><use href="#i-arrow-right" /></svg>
        </button>
        <button style={ghost}>J'ai déjà un compte</button>
      </div>
    </PhoneFrame>
  );
};
...
const Onboard3Goal = () => {
  ...
  const av = {
    ...
    fontWeight: 900, fontFamily: "Georgia, serif", fontSize: 20,
    flexShrink: 0,
  };
  ...
  return (
    <PhoneFrame bg="#fff">
      ...
      <div style={body}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          <FieldLabel>Commune <span style={{ color: "var(--gj-grey-2)", fontSize: 10, fontWeight: 600, marginLeft: 4 }}>FACULTATIF</span></FieldLabel>
    ...
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={body}>
        <div style={yayeBar}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{
              ...
              display: "inline-flex", alignItems: "center", justifyContent: "center",
              fontWeight: 900, fontFamily: "Georgia, serif", color: "#fff", fontSize: 17,
              flexShrink: 0,
            }}>Y</div>
            <div style={{ flex: 1 }}>
        ...
        <div style={oppCard("blue")}>
          <span style={accentPill("var(--gj-blue)", "var(--gj-blue-soft)")}>Stage</span>
          <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
            <div style={tile("blue")}>
...
const Onboard6Dashboard = () => {
  ...
  const glow = {
    ...
    background: "radial-gradient(circle, rgba(249,196,0,.2), transparent 60%)",
  };
  ...
  const oppPill = (color, bg) => ({
    ...
    background: bg, color, fontSize: 9, fontWeight: 900,
    ...
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={body}>
        ...
        <div style={kpiGrid}>
          <div style={k1.card}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 800, color: "var(--gj-green)" }}>+8</span>
            </div>
          ...
          <div style={k2.card}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 800, color: "var(--gj-green)" }}>+3</span>
            </div>
          ...
          <div style={k3.card}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 800, color: "var(--gj-blue)" }}>2 actives</span>
            </div>
          ...
          <div style={k4.card}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 800, color: "var(--gj-green)" }}>+1</span>
            </div>
        ...
        <div style={oppList}>
          ...
          <div style={oppCard}>
            <span style={oppPill("var(--gj-blue)", "var(--gj-blue-soft)")}>STAGE</span>
            <div style={{ width: 44, height: 44, borderRadius: 10, background: "var(--gj-blue-soft)", color: "var(--gj-blue)", display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
              <svg className="gj-icon gj-icon--md"><use href="#i-employment" /></svg>
            </div>
