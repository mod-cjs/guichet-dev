...
// --- Skeleton primitives ---
const sk = (w, h, r) => ({ width: w, height: h, borderRadius: r || 6, background: "linear-gradient(90deg, var(--gj-bg) 25%, #F0F2F5 37%, var(--gj-bg) 63%)", backgroundSize: "400% 100%", animation: "gjsk 1.4s ease infinite" });
