...
const OPP_TONE = {
  emploi: { soft: "var(--cat-emploi-soft)", ink: "var(--cat-emploi-ink)", icon: "i-employment", label: "Emploi" },
  stage:  { soft: "var(--cat-stage-soft)", ink: "var(--cat-stage-ink)", icon: "i-employment", label: "Stage" },
  bourse: { soft: "var(--cat-financement-soft)", ink: "var(--cat-financement-ink)", icon: "i-funding", label: "Bourse" },
  format: { soft: "var(--cat-formation-soft)", ink: "var(--cat-formation-ink)", icon: "i-learning", label: "Formation" },
};
