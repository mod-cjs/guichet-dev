...
const EvCover = ({ ev, height = 116, big = false }) => {
  ...
  return (
    <div style={{ position: "relative", height, background: t.grad, color: "#fff", flexShrink: 0, overflow: "hidden", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: big ? 22 : 14 }}>
      {/* Photo réelle de l'événement — fallback : bannière thématique par catégorie */}
      <div style={{ position: "absolute", inset: 0 }}>
        <image-slot id={"ev-" + (ev.id || (ev.title || "").toLowerCase().replace(/[^a-z0-9]+/g, "-").slice(0, 28))} shape="rect" fit="cover" placeholder="Photo réelle de l'événement"></image-slot>
      </div>
      <div style={{ position: "absolute", inset: 0, background: t.grad, opacity: .55, pointerEvents: "none" }} />
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(0,0,0,.28), rgba(0,0,0,.42))", pointerEvents: "none" }} />
      <svg className="gj-icon" style={{ position: "absolute", right: -14, bottom: -18, width: big ? 150 : 104, height: big ? 150 : 104, opacity: .16, color: "#fff", pointerEvents: "none" }}><use href={"#" + t.icon} /></svg>
  ...
  return (
    <aside style={{ width: 234, flexShrink: 0, alignSelf: "flex-start", position: "sticky", top: 0 }}>
      <div style={{ background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, padding: 16 }}>
        ...
        <div>
          <div style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".4px", marginBottom: 10 }}>Lieu</div>
...
const EvCheckinCard = ({ ev }) => (
  <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
    <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 11, fontWeight: 800, color: "var(--gj-teal-deep)", textTransform: "uppercase", letterSpacing: ".5px" }}>
...
const EvCheckinCardOld = ({ ev }) => (
  <div style={{ background: "linear-gradient(135deg, var(--gj-teal-deep), var(--gj-ink-teal))", color: "#fff", borderRadius: 14, padding: 16, position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", gap: 12 }}>
    <span style={{ position: "absolute", right: -40, top: -50, width: 180, height: 180, background: "radial-gradient(circle, rgba(248,163,9,.18), transparent 60%)", pointerEvents: "none" }} />
    <div style={{ display: "flex", alignItems: "center", gap: 8, position: "relative", fontSize: 11, fontWeight: 800, color: "var(--gj-yellow)", textTransform: "uppercase", letterSpacing: ".5px" }}>
      <svg className="gj-icon" style={{ width: 14, height: 14 }}><use href="#i-target" /></svg>Check-in sur place
    </div>
...
const RegisterCard = ({ ev, registered, onRegister }) => {
  ...
  const row = (icon, label, val) => (
    <div style={{ display: "flex", gap: 11, padding: "10px 0", borderBottom: "1px solid var(--gj-line)" }}>
      ...
      <div>
        <div style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".3px" }}>{label}</div>
  ...
  return (
    <div style={{ background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, padding: 18, display: "flex", flexDirection: "column", gap: 4, position: "sticky", top: 0 }}>
      ...
      {registered ? (
        ...
        <React.Fragment>
          <button onClick={onRegister} style={{ background: "var(--gj-action)", color: "#fff", border: 0, minHeight: 50, borderRadius: 10, fontWeight: 800, fontSize: 15.5, cursor: "pointer", fontFamily: "inherit", display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, padding: 18 }}>
            ...
            <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
              <div style={{ width: 120, height: 88, borderRadius: 10, flexShrink: 0, background: "repeating-linear-gradient(45deg, var(--gj-bg), var(--gj-bg) 8px, #F0F2F5 8px, #F0F2F5 16px)", border: "1.5px solid var(--gj-line)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--gj-grey-2)" }}>
  ...
  return (
    <div style={{ display: "flex", gap: 14, alignItems: "center", background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 12, padding: 14 }}>
      <div style={{ width: 56, textAlign: "center", flexShrink: 0, background: t.soft, color: t.ink, borderRadius: 10, padding: "8px 4px" }}>
        ...
        <div style={{ fontSize: 11, fontWeight: 800, textTransform: "uppercase", letterSpacing: ".4px", marginTop: 3 }}>{ev.m}</div>
      </div>
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <span style={{ fontSize: 11, fontWeight: 800, color: t.ink, background: t.soft, padding: "2px 8px", borderRadius: 999, textTransform: "uppercase", letterSpacing: ".3px" }}>{t.label}</span>
          ...
          {past && ev.attended && <span style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-green-ink)", background: "var(--gj-green-soft)", padding: "2px 8px", borderRadius: 999 }}>PRÉSENT·E</span>}
          {past && !ev.attended && <span style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-grey)", background: "var(--gj-bg)", padding: "2px 8px", borderRadius: 999 }}>ABSENT·E</span>}
        </div>
              ...
              return (
                <div key={day} style={{ aspectRatio: "1 / 1", borderRadius: 9, border: "1.5px solid var(--gj-line)", padding: 7, display: "flex", flexDirection: "column", background: has ? "var(--gj-teal-soft)" : "#fff", borderColor: has ? "var(--gj-teal)" : "var(--gj-line)", cursor: has ? "pointer" : "default" }} onClick={has ? onOpen : undefined}>
                  ...
                  <div style={{ marginTop: "auto", display: "flex", flexDirection: "column", gap: 3 }}>
                    {evs.slice(0, 2).map((e) => (
                      <div key={e.id} style={{ fontSize: 11, fontWeight: 800, color: "#fff", background: EV_TONES[e.type].grad, borderRadius: 4, padding: "2px 5px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{e.title}</div>
                    ))}
                  </div>
                </div>
              );
              ...
              return (
                <div key={e.id} onClick={onOpen} style={{ display: "flex", gap: 11, cursor: "pointer" }}>
                  <div style={{ width: 44, textAlign: "center", flexShrink: 0, background: t.soft, color: t.ink, borderRadius: 9, padding: "6px 4px" }}>
                    ...
                    <div style={{ fontSize: 11, fontWeight: 800, textTransform: "uppercase", marginTop: 2 }}>{e.m}</div>
                  </div>
                  <div style={{ minWidth: 0 }}>
