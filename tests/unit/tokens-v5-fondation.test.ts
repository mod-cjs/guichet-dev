...
describe('GUIC-690 — sentinelles de coordination et de structure', () => {
  it('tokens admin strictement intouchés (session parallèle — ne JAMAIS modifier ici)', () => {
    expect(token('--gj-admin-bg')).toBe('#11201C')
    expect(token('--gj-admin-gold-stop')).toBe('#E0A93B')
    expect(token('--gj-admin-gold')).toBe('linear-gradient(135deg, var(--gj-yellow), #E0A93B)')
    expect(token('--gj-admin-on-gold')).toBe('#11201C')
    expect(token('--gj-admin-fg')).toBe('#ffffff')
    expect(token('--gj-admin-fg-72')).toBe('rgba(255,255,255,.72)')
    expect(token('--gj-admin-fg-60')).toBe('rgba(255,255,255,.60)')
    expect(token('--gj-admin-fg-40')).toBe('rgba(255,255,255,.40)')
    expect(token('--gj-admin-surface')).toBe('rgba(255,255,255,.05)')
    expect(token('--gj-admin-border')).toBe('rgba(255,255,255,.10)')
    expect(token('--gj-admin-border-soft')).toBe('rgba(255,255,255,.07)')
