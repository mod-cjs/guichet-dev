...
import { basculerVerifiePartenaire, modifierPartenaire } from '@/app/admin/partenaires/actions'

const mockSession = getSession as jest.Mock
const mockAudit = recordAudit as jest.Mock
const mockPrisma = prisma as unknown as { organisation: { update: jest.Mock } }
