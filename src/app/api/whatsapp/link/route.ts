...
export async function GET(request: NextRequest) {
  ...
  if (!telephone) {
    return NextResponse.redirect(new URL('/auth/connexion?error=wa_link_invalid', request.url))
  }
  ...
  if (session) {
    ...
    return NextResponse.redirect(new URL('/jeune/tableau-de-bord', request.url))
  }
