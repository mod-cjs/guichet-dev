...
export const metadata: Metadata = { title: 'Conversation — Espace conseiller' }
...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ maxWidth: 760, margin: '0 auto' }}>
      <Link href="/conseiller/messagerie" className="inline-flex items-center gap-[6px] text-[12.5px] font-bold no-underline mb-[10px]" style={{ color: TEAL }}>
      ...
      <div className="rounded-[14px] p-[14px] mb-4" style={{ background: 'var(--gj-surface)', border: '1.5px solid var(--gj-line)' }}>
        ...
        {conv.offreTitre ? <p className="text-[12px]" style={{ color: 'var(--gj-grey)' }}>À propos de « {conv.offreTitre} »</p> : null}
      </div>
      <div className="mb-4"><MessageList conversation={conv} accent={TEAL} /></div>
