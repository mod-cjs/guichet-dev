...
/**
 * GUIC-522 F-13 — frontière d'erreur de /admin/bibliotheque/gestion (page `force-dynamic`,
 * sans `error.tsx` un échec de requête DB remontait un 500 brut, non cadré). Message métier +
 * bouton Réessayer (`reset` relance le rendu du segment).
 */
export default function BibliothequeGestionError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[admin/bibliotheque/gestion] erreur de rendu', error)
  }, [error])
