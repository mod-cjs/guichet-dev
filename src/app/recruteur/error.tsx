...
/**
 * Frontière d'erreur de l'espace recruteur (`/recruteur/*`) — GUIC-689 (Lot D2).
 *
 ...
 * prévu par la spec.
 */
export default function RecruteurError({
  reset,
}: {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center bg-gj-bg px-space-4 py-space-6">
      <FullPageState
        ...
        secondaryAction={{ label: 'Retour au tableau de bord', href: '/recruteur/tableau-de-bord' }}
      />
    </div>
  )
}
