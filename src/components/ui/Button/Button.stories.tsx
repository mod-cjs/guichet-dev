...
const meta: Meta<typeof Button> = {
  ...
  component: Button,
  argTypes: {
    variant: { control: 'select', options: ['primary', 'conversion', 'secondary', 'ghost', 'text', 'danger'] },
...
export const Conversion: Story = { args: { variant: 'conversion', children: 'Postuler maintenant' } }
...
export const AllVariants: Story = {
  render: () => (
    <div style={{ display: 'grid', gap: 12 }}>
      {(['primary', 'conversion', 'secondary', 'ghost', 'text', 'danger'] as const).map((v) => (
