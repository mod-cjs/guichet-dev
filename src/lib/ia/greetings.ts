...
//
// ⚠️ Français uniquement. Emoji
// autorisé mais SOBRE : au plus un par salutation, jamais en rafale (cf. system
// prompt agent.ts). La variété 0 reste canonique (« Bonjour … » + « Une offre pour
// moi »), sans emoji, pour des tests stables avec rng=()=>0.
