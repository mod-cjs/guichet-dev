      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 10 }}>
        {ADM_KPIS2.map((k, i) => (
          <div key={i} style={{ ...adCard, padding: 13 }}>
            ...
            <div style={{ fontSize: 11, color: "var(--gj-grey)", marginTop: 4, fontWeight: 600, lineHeight: 1.25 }}>{k.label}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: 20, alignItems: "start" }}>
        ...
        <div style={adCard}>
          ...
          <div style={{ display: "flex", gap: 9, alignItems: "center", marginTop: 14, padding: "11px 13px", background: "var(--gj-yellow-soft)", borderRadius: 10 }}>
            ...
            <button onClick={() => nav("moderation")} style={{ background: "var(--gj-yellow)", color: "#162c5e", border: 0, padding: "7px 13px", borderRadius: 8, fontWeight: 800, fontSize: 12, cursor: "pointer", fontFamily: "inherit" }}>Modérer</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div style={{ padding: "22px 28px 40px", overflowY: "auto", flex: 1 }}>
    <div style={{ maxWidth: 1040, margin: "0 auto" }}>
      ...
      <div style={{ background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, overflow: "hidden" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.6fr 1fr 1fr 1.4fr 0.6fr 0.7fr", gap: 14, padding: "12px 18px", borderBottom: "1.5px solid var(--gj-line)", background: "var(--gj-bg)", fontSize: 11, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".4px" }}>
  ...
  return (
    <div style={{ padding: "22px 28px 40px", overflowY: "auto", flex: 1 }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ background: "#fff", border: "1.5px solid var(--gj-line)", borderRadius: 14, overflow: "hidden" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1.2fr 1.2fr 1fr 0.6fr", gap: 14, padding: "12px 18px", borderBottom: "1.5px solid var(--gj-line)", background: "var(--gj-bg)", fontSize: 11, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".4px" }}>
  ...
  return (
    <div style={{ background: "linear-gradient(135deg, var(--gj-teal-soft), #fff)", border: "1.5px solid var(--gj-line)", borderRadius: 11, padding: 13 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 9, marginBottom: 9 }}>
        <span style={{ width: 30, height: 30, borderRadius: "50%", flexShrink: 0, background: "linear-gradient(135deg, #19a657, #027f7e)", color: "#fff", fontFamily: "var(--gj-font-sans)", fontWeight: 900, fontSize: 15, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>Y</span>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 12.5, fontWeight: 800, color: "var(--gj-ink)" }}>Analyse de Yaye <span style={{ background: "var(--gj-yellow)", color: "var(--gj-ink)", fontSize: 11, fontWeight: 900, padding: "1px 6px", borderRadius: 999, marginLeft: 3 }}>IA</span></div>
        ...
        <div style={{ textAlign: "center", flexShrink: 0 }}>
          ...
          <div style={{ fontSize: 11, color: "var(--gj-grey-2)", fontWeight: 800, textTransform: "uppercase", letterSpacing: ".3px" }}>score</div>
        </div>
      </div>
      <div style={{ display: "flex", gap: 7, flexWrap: "wrap", marginBottom: ai.reason ? 9 : 0 }}>
        {ai.checks.map(([label, ok], i) => (
          <span key={i} style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11, fontWeight: 700, padding: "3px 9px", borderRadius: 999, background: ok ? "var(--gj-green-soft)" : "var(--gj-red-soft)", color: ok ? "var(--gj-green-ink)" : "var(--gj-red-ink)" }}>
  ...
  <div style={{ padding: "22px 28px 40px", overflowY: "auto", flex: 1 }}>
    <div style={{ maxWidth: 880, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, background: "linear-gradient(135deg, var(--gj-teal-deep), var(--gj-ink-teal))", color: "#fff", borderRadius: 14, padding: "14px 18px", marginBottom: 18, position: "relative", overflow: "hidden" }}>
        <span style={{ position: "absolute", right: -40, top: -50, width: 160, height: 160, background: "radial-gradient(circle, rgba(248,163,9,.18), transparent 60%)" }} />
        <span style={{ width: 38, height: 38, borderRadius: "50%", flexShrink: 0, background: "linear-gradient(135deg, #19a657, #027f7e)", color: "#fff", fontFamily: "var(--gj-font-sans)", fontWeight: 900, fontSize: 18, display: "inline-flex", alignItems: "center", justifyContent: "center", boxShadow: "0 0 0 2px rgba(255,255,255,.2)" }}>Y</span>
        ...
        <div style={{ display: "flex", gap: 14, position: "relative" }}>
          {[["18", "Conformes", "#19a657"], ["4", "À vérifier", "var(--gj-yellow)"], ["1", "Risque", "#fe1c66"]].map(([n, l, c]) => (
            <div key={l} style={{ textAlign: "center" }}><div style={{ fontSize: 20, fontWeight: 900, color: c, lineHeight: 1 }}>{n}</div><div style={{ fontSize: 11, opacity: .8, marginTop: 2 }}>{l}</div></div>
          ))}
        </div>
      </div>
          ...
          return (
            <div key={m.id} style={{ ...adCard, padding: 16, display: "flex", flexDirection: "column", gap: 12, borderColor: ai && ai.verdict === "reject" ? "var(--gj-red)" : "var(--gj-line)" }}>
              <div style={{ display: "flex", gap: 13, alignItems: "flex-start" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <span style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-grey)", background: "var(--gj-bg)", padding: "2px 8px", borderRadius: 999, textTransform: "uppercase", letterSpacing: ".3px" }}>{m.kind}</span>
            ...
            <div key={p.id} style={{ ...adCard, padding: 16, display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                  ...
                  <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11, fontWeight: 800, padding: "3px 9px", borderRadius: 999, background: st.soft, color: st.ink }}><svg className="gj-icon" style={{ width: 12, height: 12 }}><use href={"#" + st.icon} /></svg>{p.statut}</span>
                </div>
