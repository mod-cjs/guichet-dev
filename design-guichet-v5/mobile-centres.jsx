...
const MobileCentresScreen = () => {
  ...
  const mapWrap = {
    ...
    background: "linear-gradient(135deg, #E2F1F1 0%, #CFE6E6 50%, #BBDBDB 100%)",
  ...
  const route = {
    ...
    borderRadius: 999, boxShadow: "0 0 0 4px rgba(248,163,9,.25)",
  };
  const pin = (x, y, on) => ({
  ...
  return (
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={body}>
        ...
        <div style={rdvCard}>
          <div style={dateBox}>
            <div style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-yellow-ink)", textTransform: "uppercase", letterSpacing: ".4px" }}>VEN</div>
            <div style={{ fontSize: 22, fontWeight: 900, lineHeight: 1, color: "var(--gj-ink)", marginTop: 1 }}>24</div>
            <div style={{ fontSize: 11, color: "var(--gj-grey)", fontWeight: 700, marginTop: 1 }}>MAI</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {["Conseil 1-à-1", "Ateliers CV", "Wifi", "Imprimante", "Salle réunion"].map(s => (
                <span key={s} style={{
                  fontSize: 11, fontWeight: 600, color: "var(--gj-grey)",
            ...
            <div key={i} style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                  ...
                  <span style={{ fontSize: 11, color: "var(--gj-teal-deep)", fontWeight: 800 }}>{c.km}</span>
                </div>
                <div style={{ fontSize: 11, color: "var(--gj-grey)", marginTop: 2 }}>{c.addr}</div>
                <div style={{ display: "flex", gap: 6, alignItems: "center", fontSize: 11, color: "var(--gj-grey)", marginTop: 4 }}>
          ...
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: 11, fontWeight: 800, letterSpacing: ".4px", marginTop: 2 }}>{e.m}</div>
              </div>
              <div style={{ flex: 1, minWidth: 0 }}>
