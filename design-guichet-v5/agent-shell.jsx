...
const AgentSidebar = ({ active = "home", onNavChange = () => {} }) => {
  ...
  const avatar = {
    ...
    background: "linear-gradient(135deg, var(--gj-yellow), #C97F03)",
    color: "var(--gj-ink-teal)", display: "inline-flex", alignItems: "center", justifyContent: "center",
    fontWeight: 900, fontSize: 13,
  };
  const sectionH = { fontSize: 11, color: "rgba(255,255,255,.45)", fontWeight: 800, letterSpacing: ".5px", textTransform: "uppercase", padding: "14px 10px 5px" };
  const linkBase = {
  ...
  const sections = [
    ...
    { title: "Activité du centre", items: [
      ...
      { id: "library", icon: "i-resources", label: "Bibliothèque", badge: "2" },
  ...
  return (
    <aside style={wrap}>
      <div style={brandBox}>
        <img src="assets/logo-guichet-blanc.png" alt="Guichet Jeunesse.sn" style={{ height: 28, width: "auto" }} />
        <span style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-yellow)", letterSpacing: ".5px", textTransform: "uppercase", lineHeight: 1.2, borderLeft: "1px solid rgba(255,255,255,.2)", paddingLeft: 9 }}>Espace<br />conseiller</span>
      </div>
      ...
      <div style={userChip}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 11, color: "rgba(255,255,255,.6)", marginTop: 2 }}>{AGENT.role}</div>
        </div>
      </div>
      ...
      <div style={{ marginTop: "auto", padding: "11px", background: "rgba(255,255,255,.06)", border: "1px solid rgba(255,255,255,.1)", borderRadius: 12, display: "flex", alignItems: "center", gap: 9 }}>
        ...
        <div style={{ fontSize: 11, color: "rgba(255,255,255,.7)", lineHeight: 1.4 }}>Centre d'aide & guide conseiller</div>
      </div>
    </aside>
  );
};
  ...
  return (
    <div style={wrap}>
      ...
      <button style={iconBtn} aria-label="Notifications">
        ...
        <span style={{ position: "absolute", top: -4, right: -4, minWidth: 18, height: 18, padding: "0 5px", borderRadius: 999, background: "var(--gj-red)", color: "#fff", fontSize: 11, fontWeight: 800, display: "inline-flex", alignItems: "center", justifyContent: "center", border: "2px solid #fff" }}>4</span>
      </button>
