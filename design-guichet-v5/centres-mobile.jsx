...
const mServiceChip = (s) => (
  <span key={s} style={{ display: "inline-flex", alignItems: "center", gap: 5, fontSize: 11, fontWeight: 700, color: "var(--gj-teal-deep)", background: "var(--gj-teal-soft)", padding: "5px 10px", borderRadius: 8 }}>
    <svg className="gj-icon" style={{ width: 13, height: 13 }}><use href={"#" + (M_SERVICE_ICONS[s] || "i-check")} /></svg>{s}
  </span>
);
            ...
            <div key={c.id} onClick={() => nav("detail")} style={{ background: "#fff", border: c.mine ? "1.5px solid var(--gj-teal)" : "1px solid var(--gj-line)", borderRadius: 13, padding: 13, display: "flex", gap: 12, cursor: "pointer" }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                  ...
                  {c.mine && <span style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-teal-deep)", background: "var(--gj-teal-soft)", padding: "1px 7px", borderRadius: 999, textTransform: "uppercase" }}>Mien</span>}
                  <span style={{ flex: 1 }} />
    ...
    <div key={r.id} onClick={() => nav("reserve")} style={{ background: "#fff", border: "1px solid var(--gj-line)", borderRadius: 13, padding: 13, display: "flex", gap: 12, alignItems: "center", cursor: "pointer" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
          ...
          <span style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-green-ink)", background: "var(--gj-green-soft)", padding: "1px 7px", borderRadius: 999, textTransform: "uppercase" }}>Gratuit</span>
        </div>
    ...
    <PhoneFrame>
      ...
      <div style={{ flex: 1, overflowY: "auto", background: "var(--gj-bg)" }}>
        ...
        <div style={{ background: "linear-gradient(135deg, var(--gj-teal-deep) 0%, var(--gj-ink-teal) 100%)", color: "#fff", padding: "16px", position: "relative", overflow: "hidden" }}>
          <span style={{ position: "absolute", right: -40, top: -50, width: 160, height: 160, background: "radial-gradient(circle, rgba(248,163,9,.16), transparent 60%)" }} />
          ...
          <div style={{ position: "relative", display: "flex", gap: 7, flexWrap: "wrap", marginTop: 12 }}>
            <span style={{ display: "inline-flex", alignItems: "center", gap: 5, background: "rgba(255,255,255,.12)", border: "1px solid rgba(255,255,255,.2)", padding: "4px 10px", borderRadius: 999, fontSize: 11.5, fontWeight: 700 }}><span style={{ width: 6, height: 6, borderRadius: "50%", background: "#19a657" }} />Ouvert · {c.hours}</span>
        ...
        <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ display: "flex", gap: 8, overflowX: "auto" }}>
            {["Façade", "Salle d'atelier", "Accueil"].map((p, i) => (
              <div key={p} style={{ width: 120, aspectRatio: "4/3", flexShrink: 0, borderRadius: 10, overflow: "hidden", position: "relative" }}>
                <image-slot id={"centre-m-" + i} shape="rounded" radius="10" fit="cover" placeholder={p}></image-slot>
              </div>
            ))}
          </div>
          {/* services */}
    ...
    <PhoneFrame>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 14, display: "flex", flexDirection: "column", gap: 16, background: "var(--gj-bg)" }}>
        ...
        <div style={{ background: "#fff", border: "1px solid var(--gj-line)", borderRadius: 14, padding: 13, display: "flex", gap: 12, alignItems: "center" }}>
          ...
          <span style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-green-ink)", background: "var(--gj-green-soft)", padding: "2px 9px", borderRadius: 999 }}>Gratuit</span>
        </div>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 7, justifyContent: "space-between" }}>
                    ...
                    <span style={{ display: "inline-flex", alignItems: "center", gap: 4, fontSize: 11, fontWeight: 800, color: s.ink, background: s.soft, border: `1px solid ${s.dot}`, padding: "2px 8px", borderRadius: 999, flexShrink: 0, whiteSpace: "nowrap" }}><svg className="gj-icon" style={{ width: 11, height: 11 }}><use href={"#" + s.icon} /></svg>{s.label}</span>
                  </div>
                  <div style={{ display: "flex", gap: 12, marginTop: 6, flexWrap: "wrap" }}>
...
const MobileCJSCard = ({ nav = () => {} }) => (
  <PhoneFrame>
    ...
    <div style={{ flex: 1, overflowY: "auto", padding: 14, display: "flex", flexDirection: "column", gap: 14, background: "var(--gj-bg)" }}>
      <div style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".5px" }}>Recto</div>
      <MyCJSCard />
      <div style={{ fontSize: 11, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".5px" }}>Verso</div>
      <MyCJSCardBack />
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {[
