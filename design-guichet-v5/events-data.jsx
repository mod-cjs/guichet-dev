...
const EV_TONES = {
  atelier:    { soft: "var(--gj-teal-soft)",   ink: "var(--gj-teal-deep)", grad: "linear-gradient(135deg,#027f7e,#014B4A)", label: "Atelier",     icon: "i-learning" },
  forum:      { soft: "var(--gj-blue-soft)",   ink: "var(--gj-blue-ink)",  grad: "linear-gradient(135deg,#1e35ba,#162c5e)", label: "Forum emploi", icon: "i-employment" },
  formation:  { soft: "var(--gj-yellow-soft)", ink: "var(--gj-yellow-ink)",grad: "linear-gradient(135deg,#7A4E02,#7A4E02)", label: "Formation",    icon: "i-project" },
  webinaire:  { soft: "var(--gj-green-soft)",  ink: "var(--gj-green-ink)", grad: "linear-gradient(135deg,#19a657,#0E6234)", label: "Webinaire",    icon: "i-video" },
  conference: { soft: "var(--gj-teal-soft)",   ink: "var(--gj-teal-deep)", grad: "linear-gradient(135deg,#026463,#162c5e)", label: "Conférence",   icon: "i-engagement" },
};
