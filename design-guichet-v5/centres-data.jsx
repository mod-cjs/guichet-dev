  ...
  return (
    <div style={{ position: "relative", width: "100%", height, borderRadius: 14, overflow: "hidden", background: "linear-gradient(135deg, #E2F1F1, #CFE6E6)", border: "1.5px solid var(--gj-line)" }}>
      ...
      <svg viewBox="0 0 270 205" preserveAspectRatio="xMidYMid meet" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", padding: 12 }}>
        ...
        <text x="96" y="136" textAnchor="middle" style={{ fontSize: 11, fontWeight: 700, fill: "var(--gj-grey-2)" }}>GAMBIE</text>
        <text x="16" y="56" style={{ fontSize: 11, fontWeight: 700, fill: "var(--gj-teal-deep)", opacity: .38 }} transform="rotate(-90 16 56)">ATLANTIQUE</text>
        ...
        {showLabels && active && (() => {
          ...
          return (
            <g>
              ...
              <text x={active.x} y={active.y + 18.2} textAnchor="middle" style={{ fontSize: 11, fontWeight: 800, fill: "var(--gj-red-ink)" }}>{active.label}</text>
            </g>
          );
        })()}
      </svg>
