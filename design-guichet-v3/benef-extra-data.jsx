...
const B_THREADS = [
  ...
  { id: "bt2", who: "Sonatel — Recrutement", role: "Stage Data Science", init: "S", tone: "teal", last: "Vous : Merci, je serai disponible le 11.", time: "Hier", unread: 0, online: false,
    msgs: [
  ...
  { id: "bt4", who: "GIE Diaobé", role: "Stage agronomie", init: "G", tone: "yellow", last: "Pouvez-vous nous rappeler ?", time: "28 mai", unread: 0, online: false,
    msgs: [{ me: false, t: "Pouvez-vous nous rappeler au sujet du stage ?", time: "28 mai" }] },
];

// Opportunités / ressources sauvegardées
const B_SAVED = [
  { id: "s1", kind: "emploi", type: "Emploi", title: "Développeur Web Junior · CDI", org: "Wave Mobile Money", meta: "Dakar · dès 500 000 F", deadline: "Clôture J-12", icon: "i-employment", tone: "blue" },
  { id: "s2", kind: "bourse", type: "Bourse", title: "Bourse mobilité numérique · Master 2", org: "Min. Enseignement Supérieur", meta: "International · frais + 80 000 F", deadline: "Clôture le 30 juin", icon: "i-funding", tone: "yellow" },
  { id: "s3", kind: "event", type: "Événement", title: "Forum régional de l'emploi", org: "ANPEJ · Diamniadio", meta: "28 mai · présentiel", deadline: "Gratuit", icon: "i-calendar", tone: "teal" },
  ...
  { id: "s5", kind: "format", type: "Formation", title: "Bootcamp Data Analyse · 8 semaines", org: "CJS Dakar × Sonatel Academy", meta: "Dakar · gratuit", deadline: "Sélection sur dossier", icon: "i-learning", tone: "teal" },
];
