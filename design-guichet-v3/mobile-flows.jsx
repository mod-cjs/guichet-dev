      ...
      <div style={body}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            color: "#fff", fontWeight: 900, fontFamily: "Georgia, serif", fontSize: 20,
    ...
    <PhoneFrame bg="var(--gj-bg)">
      ...
      <div style={body}>
        <div style={{ padding: "0 14px 16px", display: "flex", flexDirection: "column", gap: 10 }}>
          {[
            { tag: "URGENT · J-3", tone: "red", title: "Bourse agricole — maraîchage", sub: "600 000 F · Tambacounda", match: 94, icon: "i-agriculture" },
            { tag: "STAGE · J-12", tone: "blue", title: "Stage agronomie — Coopérative régionale", sub: "180 000 F/mois · 6 mois", match: 91, icon: "i-employment" },
            { tag: "FORMATION · J-30", tone: "teal", title: "Module pratique · maraîchage agro-écologique", sub: "Centre Kédougou · gratuit · 4 sem.", match: 83, icon: "i-learning" },
          ].map((o, i) => (
            <div key={i} style={{
              background: "#fff", border: "1.5px solid var(--gj-line)",
              borderRadius: 12, padding: 14,
              ...
              <span style={{
                ...
                background: `var(--gj-${o.tone}-soft)`,
                color: o.tone === "yellow" ? "var(--gj-yellow-ink)" : `var(--gj-${o.tone}${o.tone === "blue" ? "" : "-ink"})`,
            ...
            <div key={i} style={{
              ...
              {n.yaye ? (
                <div style={{
                  ...
                  background: "linear-gradient(135deg, #19A757, #0A807F)",
                  color: "#fff", fontWeight: 900, fontFamily: "Georgia, serif", fontSize: 17,
                  display: "inline-flex", alignItems: "center", justifyContent: "center",
                }}>Y</div>
              ) : (
              ...
              <div style={{ fontSize: 10, color: n.unread ? "var(--gj-teal-deep)" : "var(--gj-grey-2)", fontWeight: 700, whiteSpace: "nowrap", alignSelf: "flex-start" }}>{n.when}</div>
            </div>
          ))}
        </div>
