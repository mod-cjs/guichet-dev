...
const mField = (label, value, opts = {}) => (
  <div style={{ display: "flex", flexDirection: "column", gap: 2, padding: "9px 0", borderBottom: opts.last ? 0 : "1px solid var(--gj-line)" }}>
    <span style={{ fontSize: 10.5, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".4px" }}>{label}</span>
    <span style={{ fontSize: 14.5, fontWeight: 700, color: "var(--gj-ink)", fontFamily: opts.mono ? "ui-monospace, Menlo, monospace" : "inherit", display: "inline-flex", alignItems: "center", gap: 6 }}>
      {value}
      {opts.verified && <span style={{ display: "inline-flex", alignItems: "center", gap: 3, fontSize: 10, fontWeight: 800, color: "var(--gj-green-ink)", background: "var(--gj-green-soft)", padding: "1px 7px", borderRadius: 999 }}><svg className="gj-icon" style={{ width: 10, height: 10 }}><use href="#i-check" /></svg>Vérifié</span>}
    </span>
  </div>
);
...
const mLang = (lang, level, pct) => (
  <div key={lang} style={{ display: "flex", alignItems: "center", gap: 12 }}>
    <div style={{ width: 92, flexShrink: 0 }}>
      ...
      <div style={{ fontSize: 10.5, color: "var(--gj-grey)" }}>{level}</div>
    </div>
...
const MobileProfileHero = () => {
  ...
  return (
    <section style={wrap}>
      <span style={{ position: "absolute", right: -50, top: -55, width: 200, height: 200, background: "radial-gradient(circle, rgba(249,196,0,.2), transparent 60%)", pointerEvents: "none" }} />
      <div style={{ display: "flex", alignItems: "center", gap: 14, position: "relative" }}>
        <div style={{ position: "relative", width: 72, height: 72, borderRadius: "50%", flexShrink: 0, background: "linear-gradient(135deg, var(--gj-teal), #19A757)", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 26, boxShadow: "0 0 0 3px rgba(255,255,255,.18)" }}>
          AD
          <button style={{ position: "absolute", right: -2, bottom: -2, width: 26, height: 26, borderRadius: "50%", background: "var(--gj-yellow)", color: "var(--gj-teal-deep)", border: "2px solid var(--gj-teal-deep)", display: "inline-flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }} aria-label="Changer la photo">
            ...
            <div key={i} style={{ display: "flex", gap: 12 }}>
              ...
              <div style={{ flex: 1, paddingBottom: i < arr.length - 1 ? 16 : 0, minWidth: 0 }}>
                <div style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                  <span style={{ fontSize: 9, fontWeight: 800, color: t.fg, background: t.bg, padding: "2px 7px", borderRadius: 999, textTransform: "uppercase", letterSpacing: ".3px" }}>{it.kind}</span>
                  {it.current && <span style={{ fontSize: 9, fontWeight: 800, color: "var(--gj-green-ink)", background: "var(--gj-green-soft)", padding: "2px 7px", borderRadius: 999 }}>EN COURS</span>}
                </div>
    ...
    {[
      ...
      return (
        <div key={i} style={{ display: "flex", alignItems: "center", gap: 11, paddingTop: i === 0 ? 2 : 0 }}>
          ...
          <span style={{ display: "inline-flex", alignItems: "center", gap: 3, fontSize: 10, fontWeight: 800, color: s.fg, background: s.bg, padding: "3px 8px", borderRadius: 999, flexShrink: 0 }}>
    ...
    <PhoneFrame>
      ...
      <div style={scroll}>
        ...
        <div style={{ ...mCard, flexDirection: "row", alignItems: "center", gap: 13 }}>
          <div style={{ width: 60, height: 60, borderRadius: "50%", flexShrink: 0, background: "linear-gradient(135deg, var(--gj-teal), #19A757)", color: "#fff", display: "inline-flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 22 }}>AD</div>
          <div style={{ flex: 1, minWidth: 0 }}>
