...
const TopBar = ({ subtitle, user = "AD", unread = true }) => {
  ...
  return (
    <div style={wrap}>
      ...
      <div style={right}>
        <button style={ybtn} aria-label="Ouvrir Yaye">
          <span style={yav}>Y</span>
          <span style={aiBadge}>IA</span>
        </button>
...
const StepBar = ({ step, total }) => {
  ...
  return (
    <div style={{ padding: "10px 16px 6px", background: "#fff", flexShrink: 0 }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginTop: 6, fontSize: 10, color: "var(--gj-grey)", fontWeight: 700, textTransform: "uppercase", letterSpacing: ".5px" }}>
...
const FooterCTA = ({ primary, secondary, onPrimary, onSecondary }) => (
  <div style={{
    ...
    <button onClick={onPrimary} style={{
      flex: 1, background: "var(--gj-teal-deep)",
      color: "#fff", border: 0,
      padding: "0 18px", minHeight: 48,
