...
const Foundations = () => {
  const sw = (name, v, dark) => (
    <div key={name} style={{ borderRadius: 11, overflow: "hidden", border: "1.5px solid var(--gj-line)" }}>
      ...
      <div style={{ padding: "7px 9px" }}><div style={{ fontSize: 11.5, fontWeight: 800, color: swInk }}>{name}</div><div style={{ fontSize: 10, color: "var(--gj-grey)", fontFamily: "ui-monospace, Menlo, monospace" }}>{v}</div></div>
    </div>
  );
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <Block title="Typographie" sub="Échelle de titres et de corps de texte">
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          ...
          <div style={{ fontSize: 10.5, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".5px" }}>Étiquette · 10,5 majuscules</div>
        </div>
      </Block>
  ...
  <Block title="Tableau, notifications, notation & cover" sub="Affichages de données des espaces admin, événements et notifications">
    <Demo label="Tableau de données" col>
      <div style={{ border: "1.5px solid var(--gj-line)", borderRadius: 12, overflow: "hidden" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 0.6fr", gap: 12, padding: "11px 16px", background: "var(--gj-bg)", borderBottom: "1.5px solid var(--gj-line)", fontSize: 10.5, fontWeight: 800, color: "var(--gj-grey)", textTransform: "uppercase", letterSpacing: ".4px" }}><span>Utilisateur</span><span>Rôle</span><span>Statut</span><span></span></div>
        ...
        <div style={{ border: "1.5px solid var(--gj-line)", borderRadius: 12, overflow: "hidden" }}>
          {[["i-employment", "Nouvelle offre pour toi", "2 h", true], ["i-calendar", "Rappel : atelier demain", "5 h", false]].map(([ic, t, time, unread], i) => (
            <div key={i} style={{ display: "flex", gap: 11, padding: "12px 14px", borderBottom: i === 0 ? "1px solid var(--gj-line)" : 0, background: unread ? "var(--gj-teal-soft)" : "#fff", alignItems: "center" }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}><div style={{ fontSize: 12.5, fontWeight: unread ? 800 : 600, color: swInk }}>{t}</div><div style={{ fontSize: 10.5, color: "var(--gj-grey)" }}>il y a {time}</div></div>
      ...
      <div>
        ...
        <div style={{ borderRadius: 12, overflow: "hidden", border: "1.5px solid var(--gj-line)" }}>
          <div style={{ height: 80, background: "var(--prog-yeah, linear-gradient(135deg,var(--gj-teal),var(--gj-teal-deep)))", position: "relative", padding: 10 }}>
            <div style={{ background: "rgba(255,255,255,.95)", color: "var(--gj-teal-deep)", borderRadius: 9, padding: "4px 8px", textAlign: "center", width: "fit-content", lineHeight: 1 }}><div style={{ fontSize: 18, fontWeight: 900 }}>22</div><div style={{ fontSize: 8.5, fontWeight: 800, textTransform: "uppercase" }}>Mai</div></div>
            <span style={{ position: "absolute", top: 10, right: 10, background: "rgba(0,0,0,.22)", color: "#fff", fontSize: 10, fontWeight: 800, padding: "3px 9px", borderRadius: 999 }}>Atelier</span>
          </div>
