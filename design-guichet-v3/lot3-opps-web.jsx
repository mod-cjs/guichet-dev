...
// =====================================================================
const OppListCard = ({ tag, tagTone = "cjs", title, org, region, deadline, type, salary, match, fav = false }) => {
  const tones = {
    ...
    info: { bg: "var(--gj-blue-soft)", fg: "var(--gj-blue)" },
  };
  ...
  return (
    <article style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
          ...
          {match && (
            <span style={{
              ...
              padding: "2px 8px", borderRadius: 999, letterSpacing: ".3px",
            }}>{match}</span>
          )}
        </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8, justifyContent: "space-between" }}>
        ...
        }}>Voir + postuler <svg className="gj-icon gj-icon--xs"><use href="#i-arrow-right" /></svg></button>
      </div>
    </article>
  );
};
  ...
  <div>
    <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap", marginBottom: 16 }}>
      <div style={{
        ...
        />
        <kbd style={{ fontFamily: "ui-monospace,monospace", fontSize: 10, background: "var(--gj-bg)", border: "1px solid var(--gj-line)", borderRadius: 4, padding: "2px 6px", color: "var(--gj-grey-2)" }}>⌘ K</kbd>
      </div>
      <div style={{
...
const SAMPLE_OPPS = [
  { tag: "STAGE · J-3", tagTone: "urgent", title: "Stage Data Science · 6 mois", org: "Sonatel — Direction Innovation",
    ...
    deadline: { label: "Postuler avant le 29 mai", urgent: true }, match: "94% match", fav: true },
  { tag: "EMPLOI · J-12", tagTone: "cjs", title: "Développeur Web Junior · CDI", org: "Wave Mobile Money",
    ...
    deadline: { label: "Postuler avant le 7 juin" }, match: "88% match" },
  ...
  { tag: "EMPLOI · J-30", tagTone: "info", title: "Analyste BI · CDD 12 mois", org: "Société Générale Sénégal",
    ...
    deadline: { label: "Postuler avant le 25 juin" }, match: "82% match" },
  { tag: "STAGE · J-18", tagTone: "cjs", title: "Stage agronomie · Coopérative régionale", org: "GIE Diaobé · maraîchage",
    ...
    deadline: { label: "Postuler avant le 13 juin" }, match: "91% match", fav: true },
];
    ...
    <>
      ...
      <aside style={panel}>
        ...
        <div style={hero}>
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: 6, fontSize: 10.5, fontWeight: 800, background: "var(--gj-red)", color: "#fff", padding: "4px 10px", borderRadius: 999, letterSpacing: ".4px", marginBottom: 12, position: "relative" }}>
        ...
        <div style={body}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              color: "#fff", fontFamily: "Georgia, serif", fontWeight: 900, fontSize: 20,
              display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0,
              boxShadow: "0 0 0 2px rgba(0,122,92,.1)",
            }}>Y</div>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 12, fontWeight: 800, color: "var(--gj-teal-deep)" }}>
                <span style={{ fontFamily: "Georgia, serif", fontSize: 14 }}>Yaye dit :</span>
                <span style={{ background: "var(--gj-green-soft)", color: "var(--gj-green-ink)", fontSize: 10, fontWeight: 900, padding: "2px 7px", borderRadius: 999, marginLeft: 6 }}>94% match</span>
              </div>
          ...
          <div>
            ...
            <div style={keyValGrid}>
              <div style={kvCard}>
                <div style={{ fontSize: 10.5, color: "var(--gj-grey)", textTransform: "uppercase", fontWeight: 800, letterSpacing: ".4px" }}>Type</div>
                <div style={{ fontSize: 14, fontWeight: 800, marginTop: 3 }}>Stage rémunéré · 6 mois</div>
              </div>
              <div style={kvCard}>
                <div style={{ fontSize: 10.5, color: "var(--gj-grey)", textTransform: "uppercase", fontWeight: 800, letterSpacing: ".4px" }}>Rémunération</div>
                <div style={{ fontSize: 14, fontWeight: 800, marginTop: 3 }}>350 000 FCFA / mois</div>
              </div>
              <div style={kvCard}>
                <div style={{ fontSize: 10.5, color: "var(--gj-grey)", textTransform: "uppercase", fontWeight: 800, letterSpacing: ".4px" }}>Lieu</div>
                <div style={{ fontSize: 14, fontWeight: 800, marginTop: 3 }}>Dakar Plateau · hybride 2j/sem.</div>
              </div>
              <div style={kvCard}>
                <div style={{ fontSize: 10.5, color: "var(--gj-grey)", textTransform: "uppercase", fontWeight: 800, letterSpacing: ".4px" }}>Domaine</div>
          ...
          <div>
            <div style={sectH}>Profil recherché</div>
            <ul style={{ fontSize: 14, lineHeight: 1.7, paddingLeft: 18, color: "var(--gj-ink)" }}>
              <li>Bac+3 à Bac+5 (statistique, info, ingénierie quantitative)</li>
              <li>Python obligatoire · SQL souhaité · git apprécié</li>
              <li>Curieux, autonome, bonne capacité de communication FR</li>
            </ul>
          </div>
        </div>
        ...
        <div style={body}>
          ...
          <div>
            ...
            <div style={{
              ...
              <div style={{ width: 38, height: 46, borderRadius: 4, background: "var(--gj-red-soft)", color: "var(--gj-red-ink)", display: "inline-flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: 10, letterSpacing: ".3px", flexShrink: 0 }}>PDF</div>
              <div style={{ flex: 1, minWidth: 0 }}>
  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{
        width: 38, height: 38, borderRadius: "50%",
        background: "linear-gradient(135deg, #19A757, #0A807F)",
        color: "#fff", fontFamily: "Georgia, serif", fontWeight: 900, fontSize: 17,
        display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0,
      }}>Y</div>
...
Object.assign(window, { WebOppList, WebOppSlideOver, WebApplyModal, WebEmptyState, WebFilterPanel });
