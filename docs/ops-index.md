...
| Métriques machine (disque/mémoire) | **Déployé en préprod**, collecte confirmée réelle. Alerting toujours pas branché — module e-mail natif confirmé non fonctionnel (pas de MTA), option Prometheus-vers-Grafana recommandée mais pas faite (`docs/netdata.md`). | GUIC-545 |
